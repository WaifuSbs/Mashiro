...
module.exports.run = async (client, message, args) => {
    ...
    promises.forEach((value) => {
        embed.addField(`<:server:843534429892902952> Shard #${value[0]}`,`**>** Servers: **${value[1].toLocaleString()}**\n**>** Users: **${value[2].toLocaleString()}**\n**>** Channels: **${value[3].toLocaleString()}**\n**>** Uptime: **${moment.duration(value[4]).format("d:hh:mm:ss")}**\n**>** Memory: **${formatBytes(value[5])}**`, true);
    ...
    embed.setDescription(`Divided into **${total_shards} shards**\n**>** Total Servers: **${total_servers}**\n**>** Total Users: **${total_users}**\n**>** Total Channels: **${total_channels}**\n**>** Total Memory: **${formatBytes(memory)}**`)
